...
* **Recipe Management:** Full CRUD operations for recipes, including price, prep time, tags, and ingredients.
...
* **Interactive Documentation:** Auto-generated API schema and interactive documentation powered by Swagger / OpenAPI.
...
* **API Documentation:** Swagger / OpenAPI UI (drf-spectacular)
